...
# ----------------------------------------
# If reconf is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 win32 2018.04.11.15:20:10
...
ensure_lib        ./libraries/reconf/
vmap       reconf ./libraries/reconf/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/alt_pr/alt_pr.v" -work reconf
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/reconf.v"                    
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L reconf -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L reconf -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
